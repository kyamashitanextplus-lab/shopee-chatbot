...
STOCK_NG_KEYWORDS = [
    ...
    "スクイーズ", "スクイーシー",
    "耳つぼジュエリー", "耳つぼ",
    # ポケモンカード・トレカ系（価格変動激しい・転売リスク）
    "ポケモンカード", "ポケモンカードゲーム", "ポケカ", "pokemon card",
    "トレーディングカード", "trading card", "tcg",
    "拡張パック", "ブースターボックス", "booster box",
    "遊戯王", "デュエルマスターズ", "ワンピースカード",
]
...
【対象カテゴリ（この6つのみ）】
1. おもちゃ・ホビー用品（トミカ・ポケモンカード・ガンプラ・ぬいぐるみ・フィギュア・たまごっち等）
2. ファッション・アクセサリー（日本ブランドのみ：SNIDEL・BEAMS・ネックレス・バッグ・帽子等）
3. 化粧品・美容（日本コスメ：KATE・Canmake・Cezanne・FASIO・コーセー等）
4. キャラクターグッズ・アニメグッズ（ポケモン・ワンピース・鬼滅・ジブリ・サンリオ等）
5. 文具・ステーショナリー（PILOT・ZEBRA・三菱鉛筆・サクラクレパス等 日本ブランドのみ）
6. ガジェット・電子機器（日本ブランドのみ・海外対応100-240V・USB充電対応のもの）
